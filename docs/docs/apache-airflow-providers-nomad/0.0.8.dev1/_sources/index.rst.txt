...
The package provides an Airflow executor for Nomad. This component allows to submit all Airflow
tasks to a Nomad cluster.

Operators/Decorators
*************************

Multiple operators are provided to allow for individual Airflow tasks to be submitted to Nomad.
