...
DAG_ID = "test-nomad-task-operator-resource-alloc-localexecutor"
JOB_NAME = "test-nomad-task-operator-resource-alloc-localexecutor"
...
hcl_path= "/opt/airflow/dags"

with myDAG(
    dag_id=DAG_ID,
    dagrun_timeout=datetime.timedelta(minutes=10),
    tags=["nomad", "nomadtaskoperator", "nomad-provier-test-localexecutor"],
) as dag:
    run_this_first = NomadTaskOperator(
        ...
        args=["cat", f"{hcl_path}/templates/simple_batch.hcl"],
    )
